  ...
  return (
    <section className="flex_5 mx-4">
      <div>
            ...
            <div className="flex justify-center flex-wrap w-full">
              ...
              <div className="w-[23rem] sm:w-[30rem] flex-item middle">
                <div className="flex_5">
                  <div className="comunity-gradient w-[24rem] mt-16 py-4 px-10 flex_5 flex-col ">
        ...
        <div className="sm:flex justify-center items-center my-4 hidden">
          <div className="bg-[#141414] flex gap-6 rounded-full overflow-hidden text-white text-[14px] font-[600] uppercase p-2 ">
